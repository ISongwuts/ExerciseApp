        ...
        <div className="grid xl:grid-cols-2 max-sm:grid-rows-2 text-PrimaryColors xl:p-28 max-xl:p-24 max-lg:p-16 max-sm:p-9 font-body ml-4 mr-4">
            <div className="grid content-center">
                ...
                <div className="flex lg:mt-9 max-lg:mt-6 max-sm:flex-col xl:flex-row xl:justify-start max-xl:justify-center">
                    <div>
                        <button
                            className="xl:h-16 max-xl:h-16 max-lg:h-14 max-sm:h-10 w-[12rem] rounded-myConf xl:text-3xl max-xl:text-3xl max-lg:text-2xl max-sm:text-xl font-bold uppercase text-PrimaryBG bg-PrimaryColors border-2 lg:inline-block hover:text-PrimaryColors hover:border-2 hover:bg-PrimaryBG duration-200"
                            type="button"
