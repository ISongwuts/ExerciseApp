        ...
        <div className="p-10 flex flex-col justify-between bg-PrimaryBG shadow border-2 border-PrimaryColors text-PrimaryColors rounded-r-myConf font-body space-y-5 w-[50%]">
          ...
          <div>
            <form action="" className='flex flex-col space-y-1'>
              ...
              <input type="text" className=" placeholder-PrimaryColors border border-PrimaryColors p-2 text-PrimaryColors bg-[transparent] rounded-r-myConf" placeholder='enter password here.' />
              <div className='pt-5 flex items-center justify-between'>
                <button className='p-1 bg-PrimaryColors text-PrimaryBG text-xl font-bold rounded-r-myConf border-2 border-PrimaryColors w-[35%] hover:text-PrimaryColors hover:border-2 hover:bg-[transparent]'>Login</button>
